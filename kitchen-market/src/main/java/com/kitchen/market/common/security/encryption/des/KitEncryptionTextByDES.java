 ...
 * @date 2017-09-07
 */
public class KitEncryptionTextByDES {
    /**
     * 加密。
     * 完整算法 DES/CBC/PKCS5Padding
     *
     * @param plainText
     * @param keyStr
     * @return
    ...
    public static String encryptToBase64(String plainText, String keyStr) {
        ...
        byte[] encryptData = DESAlgorithmImpl.encryptText(bytePlainText, byteSeyStr, DESAlgorithmType.DES, DESWorkingType.CBC, DESPaddingType.PKCS5Padding);
        // Base64处理后返回
    ...
    public static String decryptByBase64(String base64CipherText, String keyStr) {
        ...
        byte[] byteSeyStr = keyStr.getBytes();
        byte[] byteDecryptedData = DESAlgorithmImpl.decryptText(byteCipherText, byteSeyStr, DESAlgorithmType.DES, DESWorkingType.CBC, DESPaddingType.PKCS5Padding);
