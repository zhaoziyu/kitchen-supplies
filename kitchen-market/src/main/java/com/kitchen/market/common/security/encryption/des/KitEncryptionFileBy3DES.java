 ...
 * @date 2017-09-07
 */
public class KitEncryptionFileBy3DES {
    ...
    public static void encryptFile(String srcFile, String goalFile, String secretKey) throws GeneralSecurityException, IOException {
        ...
        DESAlgorithmImpl.encryptFile(srcFile, goalFile, byteKey, DESAlgorithmType.DESede, DESWorkingType.CBC, DESPaddingType.PKCS5Padding);
    }
    ...
    public static void decryptFile(String srcFile, String goalFile, String secretKey) throws GeneralSecurityException, IOException {
        byte[] byteKey = secretKey.getBytes();
        DESAlgorithmImpl.decryptFile(srcFile, goalFile, byteKey, DESAlgorithmType.DESede, DESWorkingType.CBC, DESPaddingType.PKCS5Padding);
    }

    public static byte[] encryptFile(byte[] data, String secretKey) throws GeneralSecurityException, IOException {
        byte[] byteKey = secretKey.getBytes();
        return DESAlgorithmImpl.encryptFile(data, byteKey, DESAlgorithmType.DESede, DESWorkingType.CBC, DESPaddingType.PKCS5Padding);
    }
    public static byte[] decryptFile(byte[] data, String secretKey) throws GeneralSecurityException, IOException {
        byte[] byteKey = secretKey.getBytes();
        return DESAlgorithmImpl.decryptFile(data, byteKey, DESAlgorithmType.DESede, DESWorkingType.CBC, DESPaddingType.PKCS5Padding);
    }
